...
class SpiceController extends Controller
{
        ...
        public function searchbyCategory(Request $request){
            ...
            ->join('spices', 'spice_description.spices_id', '=','spices.id')
            ->join('spice_format', 'spice_description.spice_format_id', '=', 'spice_format.id')
            ->select('spices.name','spices.id as product_id','spice_description.spice_format_id','spice_description.image','spice_format.format')
            ->orderBy('spices.name', 'asc');
            ...
            ->select('spice_description.product_id','spice_description.name', 'spice_price.prices','spice_description.spice_format_id','spice_description.image', 'spice_description.format', 'spice_category.category')
            ->orderBy('spice_description.name','asc')
            ->get();
        ...
        $spicePrices= DB::table('spice_price')
            ->join('spice_format', 'spice_price.spice_format_id', '=', 'spice_format.id')
            ->select('spice_price.spice_format_id','spice_price.id as price_id',
             DB::raw("json_agg(json_build_object('price', spice_price.price, 'weight', spice_price.weight, 'weight_unit', spice_price.weight_unit)) as prices"))
            ->where('spice_format.format',$format)
            ->groupBy('spice_price.spice_format_id');
        ...
        $spice_category = DB::table('spice_group')
            ...
            ->select('spice_description.product_id','spice_price.spice_format_id','spice_price.price_id','spice_price.prices','spice_description.name', 'spice_description.description','spice_description.recommendation', 'spice_description.image', 'spice_description.format', 'spice_category.category')
            ->orderBy('spice_description.name','asc')
            ->first();
